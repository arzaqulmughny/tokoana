                ...
                <div class="modal__header">
                    ...
                    <div class="modal__head-right">
                        <div class="modal__head-text">
                            <h1 class="modal__title">Stock In detail</h1>
                ...
                <div class="content">
                    <table class="table-vertical">
                        <tr class="table-vertical__row">
                            <th class="table-vertical__head">SUPPLIER</th>
                            <td class="table-vertical__data" v-html="data.supplier !== null ? data.supplier.name : '-'" />
                        </tr>
                        <tr class="table-vertical__row">
                            <th class="table-vertical__head">RECEIVER</th>
                        ...
                        <tr class="table-vertical__row">
                            ...
                            <td class="table-vertical__data" v-html="data.note !== null ? data.note : '-'" />
                        </tr>
                    </table>
